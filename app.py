...
try:
    ...
    st.error(f"Failed to import cv2: {e}. Image processing will work, but video processing is disabled.")
    cv2 = None
...
if cv2 is not None:
    ...
    st.warning("Video processing is disabled due to missing cv2 dependencies.")
